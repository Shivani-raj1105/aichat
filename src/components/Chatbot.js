        ...
        <Box 
          sx={{ 
            ...
            '&::before': {
              ...
              right: 0,
              bottom: 0,
              background: 'radial-gradient(circle at top right, rgba(33, 150, 243, 0.15) 0%, transparent 70%)',
              pointerEvents: 'none',
              borderRadius: 4,
            },
          }}
            ...
            {qrCodeData && (
              <>
                ...
                <Typography variant="subtitle1" color="text.secondary" align="center" sx={{
                  ...
                  {qrCodeData.doctorInfo.name}
                </Typography>
                <Typography variant="body2" color="text.secondary" align="center" sx={{
                  fontWeight: 500,
                  color: 'primary.main',
                }}>
                  {qrCodeData.doctorInfo.specialty}
                </Typography>
        ...
        <DialogActions sx={{ 
          ...
          <Button 
            ...
            sx={{ 
              borderRadius: 2,
              px: 3,
              boxShadow: '0 4px 12px rgba(16, 111, 189, 0.2)',
              '&:hover': {
                boxShadow: '0 6px 16px rgba(13, 55, 90, 0.3)',
              },
            }}
          >
            Download QR Code
